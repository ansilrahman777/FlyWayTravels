...
const Footer = () => {
  ...
  return (
    <footer
      ...
      style={{
        background: 'linear-gradient(to top, #011b33, #c9cbcd)'
      }}
    >
      ...
      <footer className="relative py-12 px-12 tracking-wide z-20">
        <div style={{ overflow: "hidden" }}>
          <svg
            ...
            style={{ fill: "#c8cacc", width: "100%", height: 165, transform: "rotate(180deg)" }}
          >
            <path
        ...
        <div className="max-w-2xl mx-auto text-center">
          <a href='javascript:void(0)' className="inline-block"><img src="/logo_name.png" alt="Fly way"
            className="w-60" /></a>
          <p className="text-sm mt-8 text-gray-300 leading-relaxed">Discover seamless travel experiences tailored just for you.
            Whether it's a quick getaway or a long holiday,
            Flyway Travel makes every trip effortless and memorable.
          </p>
        ...
        <div className="flex max-md:flex-col gap-4">
          <ul className="flex flex-wrap gap-4">
            <li className="text-sm">
              <a href='javascript:void(0)' className="text-gray-300 font-medium hover:underline">Terms of Service</a>
            </li>
            <li className="text-sm">
              <a href='javascript:void(0)' className="text-gray-300 font-medium hover:underline">Privacy Policy</a>
            </li>
            <li className="text-sm">
              <a href='javascript:void(0)' className="text-gray-300 font-medium hover:underline">Security</a>
            </li>
          </ul>
