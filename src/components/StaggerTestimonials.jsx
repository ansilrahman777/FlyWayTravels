  ...
  return (
    <motion.div
      ...
      animate={{
        ...
        height: isActive ? (cardSize * CARD_ACTIVE_SCALE * 2) / 3 : (cardSize * 2) / 3,
    ...
    >
      ...
      >
        <h3 className="text-base sm:text-xl mb-2">"{testimonial.testimonial}"</h3>
        <p className={`text-sm italic ${isActive ? "text-indigo-200" : "text-neutral-200"}`}>
          - {testimonial.by}
        </p>
      </div>
    </motion.div>
...
const TESTIMONIAL_DATA = [
  {
    tempId: 0,
    testimonial: "Explore iconic skyscrapers, beaches, and world-class shopping in one unforgettable city.",
    by: "Dubai City Tour",
    imgSrc: fwm3,
  },
  {
    tempId: 1,
    testimonial: "Experience thrilling dune bashing, camel rides, and a sunset desert BBQ.",
    by: "Desert Safari Adventure",
    imgSrc: fwm4,
  },
  {
    tempId: 2,
    testimonial: "Visit the majestic Sheikh Zayed Mosque and stroll Abu Dhabi's vibrant Corniche.",
    by: "Abu Dhabi City Tour",
    imgSrc: fwm5,
  },
  {
    tempId: 3,
    testimonial: "Discover ancient ruins, coastal villages, and mouthwatering pizza in every town.",
    by: "Italy Escape Package",
    imgSrc: fwm3,
  },
  {
    tempId: 4,
    testimonial: "Tour multiple European cities, from Paris to Amsterdam, in one seamless journey.",
    by: "Europe Discovery Package",
    imgSrc: fwm2,
  },
  {
    tempId: 5,
    testimonial: "Wander through souks, palaces, and the Sahara on a mesmerizing cultural adventure.",
    by: "Morocco Explorer",
    imgSrc: fwm5,
  },
  {
    tempId: 6,
    testimonial: "Stroll charming medieval streets and enjoy legendary nightlife in the heart of Prague.",
    by: "Prague City Break",
    imgSrc: fwm4,
  },
  {
    tempId: 7,
    testimonial: "Admire delicate cherry blossoms and tranquil temples in Japan's cultural capital.",
    by: "Kyoto Blossom Tour",
    imgSrc: fwm3,
  },
  {
    tempId: 8,
    testimonial: "Explore stunning coastlines, Table Mountain, and famous vineyards in South Africa.",
    by: "Cape Town Escape",
    imgSrc: fwm2,
  },
  {
    tempId: 9,
    testimonial: "Hike crystal-clear lakes and towering peaks in Canada’s most iconic park.",
    by: "Banff Adventure Package",
    imgSrc: fwm1,
  },
  {
    tempId: 10,
    testimonial: "Unwind with spectacular sea views, whitewashed villages, and Mediterranean sunsets.",
    by: "Santorini Honeymoon",
    imgSrc: fwm2,
  },
  {
    tempId: 11,
    testimonial: "Wander colorful streets, enjoy coastal views, and discover Lisbon’s hidden gems.",
    by: "Lisbon City Tour",
    imgSrc: fwm1,
  },
];
