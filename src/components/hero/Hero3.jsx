...
import hero3 from '../../assets/images/hero3.jpg'; // Ensure the image path is correct

function Hero3() {
    return (

        <section
            className="relative bg-fixed bg-center bg-cover overflow-hidden m-0 p-0"
            style={{ backgroundImage: `url(${hero3})` }}
        >
            <div className="relative z-10 bg-black bg-opacity-20 text-white py-16">
                <div className="max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 px-4 md:px-8">
                    {/* TEXT FIRST (ALWAYS FIRST ON MOBILE) */}
                    <div className="flex flex-col w-full lg:w-1/2 justify-center items-start text-left space-y-4">
                        <h1 className="text-3xl md:text-5xl font-extrabold tracking-wide">
                            Fly way Travel
                        </h1>
                        <h2 className="text-2xl md:text-4xl leading-tight md:leading-snug">
                            Your gateway to unforgettable journeys.
                        </h2>
                        <p className="text-sm md:text-base text-justify text-white/90">
                    ...
                    <div className="w-full lg:w-1/2 flex justify-center items-center min-h-[400px]">
                        <div className="relative w-full h-full max-w-[700px] aspect-video lg:aspect-square">
                            <div className="absolute inset-0 bg-gray-300 z-10">
                                ...
                                <img src={img1234} alt="Promo" className="absolute left-0 top-0 w-full h-full object-contain z-10" />
