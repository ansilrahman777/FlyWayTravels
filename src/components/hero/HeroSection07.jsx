        ...
        <div className="relative flex-1 hidden md:flex items-center justify-center">
          ...
          {[
            [
              "fas fa-hotel",
              "Hotel Booking",
              "top-6 left-16 md:top-14 md:left-24",
            ],
            [
              "fas fa-plane-departure",
              "Flight Tickets",
              "top-2 right-14 md:top-1 md:right-20",
            ],
            [
              "fas fa-car",
              "Airport Transfer",
              "bottom-14 left-2 md:bottom-14 md:left-16",
            ],
            [
              "fas fa-user-tie",
              "Tour Guide",
              "bottom-16 right-8 md:bottom-20 md:right-16",
            ],
